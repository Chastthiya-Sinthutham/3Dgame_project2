...
@onready var animation = $"Player/Root Scene/AnimationPlayer"
...
func perform_jump():
	...
	jumpTween()
	animation.play("CharacterArmature|CharacterArmature|CharacterArmature|Jump|CharacterArmature|Jump")
	velocity.y = jump_force

func perform_flip_jump():
	AudioManager.jump_sfx.play()
	AudioManager.jump_sfx.pitch_scale = 0.8
	animation.play("CharacterArmature|CharacterArmature|CharacterArmature|Jump|CharacterArmature|Jump", -1, 2)
	velocity.y = jump_force
	await animation.animation_finished
	can_double_jump = false
	animation.play("CharacterArmature|CharacterArmature|CharacterArmature|Jump|CharacterArmature|Jump", 0.5)
...
func player_animations():
	...
	if is_on_floor():
		if is_moving(): # Checks if player is moving
			animation.play("CharacterArmature|CharacterArmature|CharacterArmature|Run|CharacterArmature|Run", 0.5)
			particle_trail.emitting = true
			footsteps.stream_paused = false
		else:
			animation.play("CharacterArmature|CharacterArmature|CharacterArmature|Idle|CharacterArmature|Idle", 0.5)
